...
Persistent rotation(EEPROM_ROTATION);
FracSec fracsec;
...
void setup() {
  ...
  rotation = EEPROM.read(EEPROM_ROTATION);
  ...
  switch (mode) {
    ...
    case Mode::CALIBRATION:
      if (button_press(Button::DOWN)) {
        rotation = rotation - 1;
      } else if (button_press(Button::UP)) {
        rotation = rotation + 1;
      }
      setInner(pixels, 0,
